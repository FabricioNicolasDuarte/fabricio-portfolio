<template>
  <div class="flex min-h-screen flex-col bg-paper font-sans text-ink">
    <main id="contenido" tabindex="-1" class="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-5 py-24 sm:px-8">
