...
const work = [
  ...
  },
  {
    ...
    summaryEn:
      'Delta medallion (bronze/silver/gold): Airflow DAG, PySpark jobs, MERGE on captured_at, quarantine and quality gates. Gold: ADG (gap ≥ 7 d, clip, withdrawal window), stocking AU/ha, THI risk hours, % BCS < 4. Docker runtime; optional Databricks Free Edition. 2,000 animals × 90 days.',
    role: 'Diseño del DAG, jobs Spark y serving de KPIs.',
    roleEn: 'DAG design, Spark jobs, and KPI serving.',
    kindEn: 'Data engineering · AgTech',
    tags: ['Airflow', 'PySpark', 'Delta Lake', 'Databricks', 'Docker'],
    tagsEn: ['Airflow', 'PySpark', 'Delta Lake', 'Databricks', 'Docker'],
