    ...
    <div class="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_300px]">
      <div>
        ...
        <div class="mt-8 flex flex-wrap gap-3 animate-rise" style="animation-delay: 200ms">
          <NuxtLink to="/agendar" class="rounded-full bg-cyan-400 px-6 py-2.5 text-sm font-semibold text-slate-950 shadow-[0_0_32px_rgba(34,211,238,0.35)] transition hover:bg-cyan-300">
            {{ t.hero.book }}
          </NuxtLink>
      ...
      <div class="relative mx-auto w-full max-w-[260px] lg:max-w-none">
        <div class="absolute -inset-3 rounded-full bg-[conic-gradient(from_180deg,#22d3ee,#818cf8,#22d3ee)] opacity-40 blur-[1px]"></div>
